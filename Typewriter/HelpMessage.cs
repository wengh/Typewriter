...
Special strokes:
    {s<n>}   sleep for n milliseconds
    {i<n>}   set the interval between two strokes to n milliseconds
...
Examples:
    ...
    typewriter {s1000}{i0}{Up 10}
        Sleep 1 second then type Up arrow 10 times with no delay

    typewriter +{sc86}
        Type the extra \ key on ISO keyboard while holding Shift

    typewriter {Space down}{s500}{Space up}
        Hold Space bar for 500 milliseconds
